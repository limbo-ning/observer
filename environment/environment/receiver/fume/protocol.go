...
func init() {
	protocol.Register(PROTOCOL_FUME, func() protocol.IProtocol {
		return &Fume{}
	})
}
...
func (p *Fume) Redirect(redirection, datagram, dataType string, dataTime *time.Time, datas map[string]string) {
